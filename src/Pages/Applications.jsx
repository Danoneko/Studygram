...
const Applications = () => {
  ...
  const [blocks, setBlocks] = useState(dataUser); // построение/поведение/ре-рендеринг блоков
  ...
  function sorting(value) {
    const copyData = dataUser.concat();
    let sortData;
    if (sortClick === false) {
          ...
          <>
            ...
            {currentBlocksIndex.map((it, key) => (
              <ListGroup.Item className="inner-container__block" key={key}>
                ...
                <div className="inner-container__block-defoult chat__users--flex ">
                  <div
                    className="inner-container__block-detele"
                    onClick={() => deleteUser(it)}
                  >
                    <div className="img__accept"></div> Принять
                  </div>
                  <div
                    className="inner-container__block-detele"
                    onClick={() => deleteUser(it)}
                  >
                    <div className="img__reject"></div> Отклонить
                  </div>
                </div>
              </ListGroup.Item>
            ))}
